...
const appCss = "/assets/styles-Cayk2w2w.css";
...
const Route$1 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#F4EFE9" },
      { name: "author", content: "Studio Hélio" },
      { property: "og:site_name", content: "Studio Hélio" },
...
const $$splitComponentImporter = () => import("./index-NUvSQ9Gl.mjs");
const Route = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Studio de Pilates en petits groupes (6 max) à Bordeaux. Coachs diplômés, progrès mesurés. Réserve ton premier cours d'essai gratuit."
    }, {
      property: "og:title",
      content: "Studio Hélio — Pilates & Mobilité à Bordeaux"
    }, {
      property: "og:description",
      content: "Renforce ton corps sans le casser. Pilates en petits groupes (6 max), encadré, pour gagner en force, souplesse et sérénité."
    }, {
      property: "og:url",
      content: "/"
    }, {
      ...
      content: "Pilates en petits groupes à Bordeaux. Premier cours offert."
    }],
    links: [{
      rel: "canonical",
      href: "/"
    ...
    scripts: [{
      ...
      children: JSON.stringify({
        ...
        "@type": "HealthClub",
        name: "Studio Hélio",
        description: "Studio de Pilates et mobilité en petits groupes à Bordeaux.",
        address: {
          "@type": "PostalAddress",
